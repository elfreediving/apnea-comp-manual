...
8. [Check-in](#check-in)
9. [Judging results](#judging-results)
10. [Penalties (Rulebook 17.7)](#penalties-rulebook-177)
11. [Schedule adjustments (OT Delay)](#schedule-adjustments-ot-delay)
12. [Push notifications](#push-notifications)
13. [Offline operation](#offline-operation)
14. [AIDA integration](#aida-integration)
15. [Multi-day events](#multi-day-events)
16. [Results and export](#results-and-export)
17. [FAQ](#faq)
18. [Troubleshooting](#troubleshooting)
19. [Privacy & Data](#privacy--data)
20. [Contact](#contact)
...
- **What is stored** — your account email, display name, profile picture (if you upload one), AIDA athlete UUID (if you signed up as an athlete), push notification token (if notifications are enabled), and the competition data you enter (athlete results, check-in status, activity logs).
...
- **Where** — Supabase (currently US region), encrypted at rest, accessed only via Row-Level Security policies that scope data per-event. Push notifications transit through Firebase Cloud Messaging (Google).
